...
const ScheduleDashboard: React.FC<ScheduleDashboardProps> = ({ user, tasks }) => {
	...
	return (
		<div style={{ padding: "2rem", background: "linear-gradient(to bottom, #4B0082, #000000, #ffffff)", minHeight: "100vh" }}>
			...
			<p style={{ color: "#fff", fontSize: "1.5rem" }}>
				Welcome, <span style={{ fontWeight: "bold" }}>{user?.username || "User"}</span>
			</p>

			<div style={{ margin: "2rem 0", background: "#fff", borderRadius: "1rem", padding: "1rem" }}>
			...
			<div style={{ marginBottom: "2rem", background: "#fff", borderRadius: "1rem", padding: "1rem" }}>
				<h2 style={{ color: "#4B0082" }}>Ongoing & Pending Tasks</h2>
				{taskList.length === 0 ? (
			...
			<div style={{ background: "#fff", borderRadius: "1rem", padding: "1rem" }}>
